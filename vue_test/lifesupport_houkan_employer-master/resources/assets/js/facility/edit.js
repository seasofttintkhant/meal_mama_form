...
const app =  new Vue({
    ...
    mounted(){
      this.facility =JSON.parse($('#facility-data').val());
      this.getFacility();
      this.getYears();   
      this.getPrefectures();   
    ...
    methods : {
      getFacility()
      {
        ...
        this.facility_category_id=facility.facility_category_id
        if(facility.service_types !==null)
        {
          this.service_types = facility.service_types.split(',')
        }
        this.name =facility.name 
        this.name_kana = facility.name_kana 
        this.zip = facility.zip
        this.prefecture_id = facility.prefecture_id
        this.getCities(this.prefecture_id);
        this.city_id=facility.city_id
        this.street_address= facility.street_address
        this.lat = facility.lat
        this.lng = facility.lng

        this.establish_year =facility.establish_year
        this.establish_month =facility.establish_month
        this.establish_day =facility.establish_day
        this.building =facility.building
        this.work_environment_checked=facility.work_environment_checked
        this.question_1 = facility.question_1
        this.question_2 = facility.question_2
        this.question_3 = facility.question_3
        this.question_4 = facility.question_4
        this.question_5 = facility.question_5
        this.question_6 = facility.question_6
        this.access = facility.access
        this.number_of_beds = facility.number_of_beds 
        this.emergency_designation = facility.emergency_designation
        this.open_time = facility.open_time
        this.holiday = facility.holiday
        this.average_patients = facility.average_patients
        this.ambulance_per_year = facility.ambulance_per_year
        this.staff_info = facility.staff_info
        this.fulltime_doctor_info = facility.fulltime_doctor_info
        this.parttime_doctor_info = facility.parttime_doctor_info
        this.equip_info = facility.equip_info
        this.director_name = facility.director_name
        this.director_history = facility.director_history
        this.has_dormitory = facility.has_dormitory
        this.has_nursery = facility.has_nursery
        this.prescription_kind = facility.prescription_kind
        this.avarage_prescription_number = facility.avarage_prescription_number
        this.visiting_area = facility.visiting_area
        this.target_age = facility.target_age
        this.capacity = facility.capacity
        this.fetchPhotos(); 
        this.getServiceTypes(this.facility_category_id)
        this.getMonths()
        this.getDays()
      },
      getYears(){
      ...
      getServiceTypes(id,change = false){
        ...
        if(id!=="")
        {
          ...
          .then(res => res.json())
          .then(res => {
            // this.service_types = res.service_types;
            var rows = 1;
      ...
      handleSubmit(facility_id){
         ...
         data._method = _method
          ...
          this.$http.post('/facilities/'+facility_id,data).then(response => {		
      ...
      fetchPopupPhotos(){
        ...
        this.$http.get('/employers/image/',{params: params})
          .then(res => res.json())
          .then(res => {
          this.images = res.data
      });
