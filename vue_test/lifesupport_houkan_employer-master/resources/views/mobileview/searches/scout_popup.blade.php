<div class="modal fade" id="scout-popup">
             ...
             <form action="" method="" accept-charset="utf-8">
               ...
               <div class="">
                 <div class="ds-o-flex__item">
                  ...
                  <div class="ds-o-flex-item">
                    <a href="#" class="c-m-button" data-popup_target="#fill-popup"  v-if="!selected_job_option_name">求人を選択</a>
                    <div class="message-info message-included" v-if="selected_job_option_name">
                      @{{selected_job_option_name}}
                      <span class="message-dismiss-no-js" @click.prevent="clearMessageOption">&times;</span>
                    </div>
                  ...
                  <div class="card-option">
                    <label class="card-selectbox">
                      <select name="employment_type" id="employment_type" class="card-selectbox-select" v-bind:class="{'c-m-selectbox__select--disabled': !show_message_options}" :disabled="!show_message_options">
                          <option v-for="scout_employment_type in scout_employment_types" :value="scout_employment_type.id">@{{scout_employment_type.name}}</option>
                      </select>
              ...
              <div class="m-space-md"></div>
                <div class=""  v-if="!mulitple_scout">
                  ...
                  <div class="ds-o-flex-item">
                    <a href="#" title="" data-popup_close="scout-popup" data-popup_open="profile-popup" class="add-more-modal popup-close-open" @click="getProfile(jobseeker.id,true)" class="c-m-text-link m-fs-sm"><span>広島県広島市安佐北区／</span><span>33歳／</span><span>男性／</span><span>00238018／</span><span>柔道整復師</span></a>
                  </div>
                </div>
                <div class="m-space-md"></div>
                <div class="">
